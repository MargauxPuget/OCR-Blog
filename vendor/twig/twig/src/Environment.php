...
class Environment
{
    ...
    public function getTemplateClass(string $name, int $index = null): string
    {
        ...
        return $this->templateClassPrefix.hash(\PHP_VERSION_ID < 80100 ? 'sha256' : 'xxh228', $key).(null === $index ? '' : '___'.$index);
    }
    ...
    {
        $hash = hash(\PHP_VERSION_ID < 80100 ? 'sha256' : 'xxh228', $template, false);
        if (null !== $name) {
